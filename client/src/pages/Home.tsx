...
function StatsSection() {
  ...
  return (
    <section className="bg-[oklch(0.06_0.01_240)] py-16 border-y border-[oklch(0.18_0.01_240)]">
...
function ServicesSection() {
  ...
  return (
    <section id="services" className="py-24 bg-[oklch(0.09_0.01_240)]">
      <div className="container" ref={ref}>
        {/* Section Header */}
...
function IndustriesSection() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[oklch(0.06_0.01_240/0.92)]" />
            ...
            <div
              ...
              className={`p-6 border transition-all duration-700 group ${
                industry.highlight
                  ...
                  : "border-[oklch(0.25_0.01_240)] bg-[oklch(0.09_0.01_240/0.7)] hover:border-[oklch(0.72_0.18_65)/0.4] hover:bg-[oklch(0.09_0.01_240/0.9)]"
...
function TechnologySection() {
  ...
  return (
    <section id="technology" className="py-24 bg-[oklch(0.09_0.01_240)]">
      <div className="container" ref={ref}>
...
function AboutSection() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[oklch(0.06_0.01_240/0.88)]" />
...
function ContactSection() {
  ...
  const inputClass = "w-full bg-[oklch(0.14_0.01_240)] border border-[oklch(0.25_0.01_240)] text-[oklch(0.85_0.005_240)] placeholder-[oklch(0.40_0.01_240)] px-4 py-3 text-sm font-['Open_Sans'] focus:outline-none focus:border-[oklch(0.72_0.18_65)] transition-colors";

  return (
    <section id="contact" className="py-24 bg-[oklch(0.06_0.01_240)]">
      <div className="container" ref={ref}>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  >
                    <option value="" className="bg-[oklch(0.14_0.01_240)]">Select a service...</option>
                    <option value="laser-cladding" className="bg-[oklch(0.14_0.01_240)]">Laser Cladding</option>
                    <option value="hardfacing" className="bg-[oklch(0.14_0.01_240)]">Hardfacing</option>
                    <option value="component-repair" className="bg-[oklch(0.14_0.01_240)]">Component Repair</option>
                    <option value="corrosion-protection" className="bg-[oklch(0.14_0.01_240)]">Corrosion Protection</option>
                    <option value="laser-hardening" className="bg-[oklch(0.14_0.01_240)]">Laser Hardening</option>
                    <option value="custom" className="bg-[oklch(0.14_0.01_240)]">Custom Solution</option>
                  </select>
                </div>
...
export default function Home() {
  return (
    <div className="min-h-screen bg-[oklch(0.09_0.01_240)]">
      <Navbar />
      <HeroSection />
      <StatsSection />
      <ServicesSection />
